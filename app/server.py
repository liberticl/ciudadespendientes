...
def index():
    ...
    return render_template("index.html", periodo=ALLOWED_YEARS, comunas=ALLOWED_CITIES)
...
def show_data():
    ...
    center = get_polygon_middle_point(cities[0], collection)
    m = color_ride_map(cities[0], center, years, collection)
